...
/* eslint-disable */
// Creamos una function que incluya el conjntos de ubicaciones
var displayMap = function displayMap(locations) {
  var tokenPlaceHolder = 'pk.eyJ1IjoiZWxkZXphdmFsYSIsImEiOiJjbDB0d3RsNjEwcnV5M2pvMnZ4dHR6Mmk2In0.T_TrymVuHSQmLyHxt7KaIA';
  mapboxgl.accessToken = tokenPlaceHolder;
  var map = new mapboxgl.Map({
    container: 'map',
    //   style: 'mapbox://styles/eldezavala/cl0ttrbpm000l14oqp1opuquu',
    style: 'mapbox://styles/mapbox/light-v10',
    scrollZoom: false //   center: [-118.113491, 34.1117545], // first longitude after latitude
    //   zoom: 10,
    //   interactive: false,

  }); // Area que se mostrara en el mapa

  var bounds = new mapboxgl.LngLatBounds(); // Creamos un nuevo elemento HTML
  ...
  locations.forEach(function (loc) {
    ...
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")) // <-- Colocamos un parrafo con la descripcion.
    .addTo(map); // Extend map bounds to include current location. // Extendemos los limites con nuestras coordenadas.
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'singed Up in successfully!'); // Mandamos mensaje de logeo exitoso.
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Logged in successfully!'); // Mandamos mensaje de logeo exitoso.
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            // Actualizamos el possword en otra url soo si lo incluye.
...
var stripe = Stripe('pk_test_51KgyZJGuNfNgJ7LTmH8jxJBioIP3zPRL2XDpWek6eGPdIzvHNagGko0i3fstREdwxeuy0zSDICaOmQPzZN3w2Ks500j0IbuAGF'); // Esta funcion incluira un ID de recorrido.
...
// Seleccionamos nuestro elemento de la pagina web
// DOM ELEMENTS
var mapBox = document.getElementById('map');
var singUpForm = document.querySelector('.form--singup');
var loginForm = document.querySelector('.form--login');
var logOutBtn = document.querySelector('.nav__el.nav__el--logout');
var userDataForm = document.querySelector('.form-user-data');
var userPasswordForm = document.querySelector('.form-user-password');
var bookBtn = document.getElementById('book-tour'); // DELEGATION  // <-- Si en el documento existe mapBox evitara que se ejecute en otros archivos.
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            passwordConfirm = document.getElementById('password-confirm').value; // const photo = document.querySelector('img').setAttribute('src', url);
            // console.log(photo);
