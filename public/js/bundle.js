...
var userPasswordForm = document.querySelector('.form-user-password'); // DELEGATION  // <-- Si en el documento existe mapBox evitara que se ejecute en otros archivos.
...
if (userPasswordForm) userPasswordForm.addEventListener('submit', function (e) {
  ...
  var password = document.getElementById('password').value;
  var passwordConfirm = document.getElementById('password-confirm').value; // const photo = document.querySelector('img').setAttribute('src', url);
  // console.log(photo);
