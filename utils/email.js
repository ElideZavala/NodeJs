...
module.exports = class Email {
  constructor(user, url) {
    ...
    this.from =
      process.env.NODE_ENV === 'production'
        ? `Elide Zavala <${process.env.SENDGRID_EMAL_FROM}>`
        : `Elide Zavala <${process.env.EMAIL_FROM}>`;
  }
  ...
  async send(template, subject) {
    ...
    const mailOptions = {
      // from: process.env.SENDGRID_EMAIL_FROM, // <-- production mode
      from: this.from, // <-- development mode
